...
class MaterialModel {
  ...
  const MaterialModel({
    ...
    this.descripcion, required this.categoriaId, required this.unidadMedidaId,
    required this.precioReferencia, required this.stockActual,
    required this.stockMinimo, this.stockMaximo,
    required this.activo, required this.estadoStock,
  });

  factory MaterialModel.fromJson(Map<String, dynamic> json) => MaterialModel(
    id: json['id'] as int, codigo: json['codigo'] as String,
    nombre: json['nombre'] as String, descripcion: json['descripcion'] as String?,
    categoriaId: json['categoriaId'] as int, unidadMedidaId: json['unidadMedidaId'] as int,
    ...
    stockMaximo: json['stockMaximo'] != null ? (json['stockMaximo'] as num).toDouble() : null,
  ...
  MaterialItem toEntity() => MaterialItem(
    ...
    precioReferencia: precioReferencia, stockActual: stockActual,
    stockMinimo: stockMinimo, stockMaximo: stockMaximo,
    activo: activo, estadoStock: _parseEstado(estadoStock),
  );
